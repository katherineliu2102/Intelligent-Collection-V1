...
public class AdminMockDataController {
    ...
    public Map<String, Object> seedCase(@RequestBody(required = false) Map<String, Object> body) {
        long caseId = body == null || body.get("caseId") == null ? 92002L : Long.parseLong(String.valueOf(body.get("caseId")));
        long userId = body == null || body.get("userId") == null ? caseId : Long.parseLong(String.valueOf(body.get("userId")));
    ...
    public Map<String, Object> seedException(@RequestBody(required = false) Map<String, Object> body) {
        long caseId = body == null || body.get("caseId") == null ? 92002L : Long.parseLong(String.valueOf(body.get("caseId")));
        Long planId = body == null || body.get("planId") == null ? null : Long.parseLong(String.valueOf(body.get("planId")));
        Long stepId = body == null || body.get("stepId") == null ? null : Long.parseLong(String.valueOf(body.get("stepId")));
        String type = body == null || body.get("type") == null ? "CALLBACK_TIMEOUT" : String.valueOf(body.get("type"));
        String channel = body == null || body.get("channel") == null ? "SMS" : String.valueOf(body.get("channel"));
        String errorCode = body == null || body.get("errorCode") == null ? "TIMEOUT" : String.valueOf(body.get("errorCode"));
        String message =
