 ...
 * 触达结果。对应领域模型 §6.2。
 *
 * <p>priority 用于回调更新时的"只升级不降级"判定：
 * DELIVERED(1) &lt; READ(2) &lt; CLICKED(3) &lt; REPLIED(4)。
...
public enum ContactResult {
    ...
    /**
     * 回调更新时判断 newResult 是否应覆盖 currentResult。
     * 仅当 newResult 的 priority 严格大于 currentResult 时升级。
     */
