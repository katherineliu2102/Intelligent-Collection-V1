...
/** 案件上下文。ContextSnapshot 组成部分。对应领域模型 §4.1。 由 CaseService.buildContext(caseId) 构建。 */
@Data
public class CaseContext {
    ...
    /**
     * Phase 1 Mock：显式指定 Email 里程碑 scriptSlot（E2E 联调）。 为空时由 {@code
     * EmailMilestoneScriptSlots.resolveByDpd(dpd)} 推断。
     */
