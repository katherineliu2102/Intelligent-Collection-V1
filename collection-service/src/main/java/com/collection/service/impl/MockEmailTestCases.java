...
final class MockEmailTestCases {
    ...
    static {
        ...
        m.put(
                92001L,
                c(92001L, "test_s0_user1", 0, Stage.S0, "5000.00", null, "S0_DUE_TODAY_EMAIL"));
        m.put(
                92002L,
                c(92002L, "test_s0_user2", 0, Stage.S0, "5000.00", null, "S0_DUE_TODAY_EMAIL"));
        m.put(
                93101L,
                c(
                        93101L,
    ...
    private static EmailTestCase c(
            Long caseId,
            String alias,
            int dpd,
            Stage stage,
    ...
    private static EmailTestCase g(
            Long caseId,
            String alias,
            int dpd,
            Stage stage,
    ...
    private static EmailTestCase mk(
            Long caseId,
            String alias,
            int dpd,
            Stage stage,
