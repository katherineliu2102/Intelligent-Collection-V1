...
/**
 * t_collection 原始行（只取 Phase 1 组装 ContextSnapshot 所需列）。 依赖 map-underscore-to-camel-case=true
 * 完成列名→字段映射。 注意：{@code collecitonStatus} 对应旧库列 {@code colleciton_status}（旧库列名拼写如此）。
 */
@Data
