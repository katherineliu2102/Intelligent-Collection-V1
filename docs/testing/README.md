...
| [8/29–8/31 自动跑综述](./MOCASA催收系统升级_Phase1_自动跑综述_20260829-0831.md) | 三天结果、问题、改动、验证；8/31 11:58 手动日切已续上 8 案 S2 |
...
| [8/31 自动跑记录](./MOCASA催收系统升级_Phase1_自动跑记录_20260831.md) | 空名单首跑；11:53 发版续档；11:58 手动日切 `stageChanged=10`（8 案 S1→S2 + 2 案 S2→S3） |
