...
> **关联文档**: [领域模型与数据定义](../MOCASA催收系统升级_Phase1_领域模型与数据定义.md)（EventPayload / 逐事件字段）、[ContextSnapshot.sample.json](./ContextSnapshot.sample.json)、[数据接入规格](../MOCASA催收系统升级_Phase1_数据接入规格.md#34-与-caseservice--profileservice-的调用边界)
